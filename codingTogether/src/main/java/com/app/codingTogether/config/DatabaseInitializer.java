...
public class DatabaseInitializer {
    ...
    private void saveUsers() {
    	...
    	u.setProfileImage(getImage("images/img.png"));
    	...
    	u2.setProfileImage(getImage("images/Python (2).png"));
    	...
    	u3.setProfileImage(getImage("images/Python (2).png"));
    	...
    	u4.setProfileImage(getImage("images/img.png"));
    	...
    	u5.setProfileImage(getImage("images/img.png"));
    	...
    	u6.setProfileImage(getImage("images/img.png"));
    	...
    	u7.setProfileImage(getImage("images/img.png"));
    	...
    	u8.setProfileImage(getImage("images/img.png"));
    	...
    	u9.setProfileImage(getImage("images/img.png"));
