...
public class DatabaseInitializer {
    ...
    private void saveUsers() {
    	...
    	u2.setProfileImage("https://res.cloudinary.com/djnkw1sa9/image/upload/v1691188155/samples/shoe.jpg");
    	...
    	u3.setProfileImage("https://res.cloudinary.com/djnkw1sa9/image/upload/v1691188155/samples/shoe.jpg");
    	userRepository.save(u3);
    	User u4 = new User();
    	u4.setUsername("LearningToCode");
    	u4.setPassword(PasswordEncoder.hashPassword("encodedPassword"));
    	u4.setFavoriteLanguage(new FavoriteLanguage(null,"Java", "Medio"));
    	u4.setProfileImage("https://res.cloudinary.com/djnkw1sa9/image/upload/v1691188155/samples/shoe.jpg");
    	userRepository.save(u4);
    	User u5 = new User();
    	u5.setUsername("CodeFusion");
    	u5.setPassword(PasswordEncoder.hashPassword("encodedPassword"));;
    	u5.setFavoriteLanguage(new FavoriteLanguage(null,"Java", "Medio"));
    	u5.setProfileImage("https://res.cloudinary.com/djnkw1sa9/image/upload/v1691188155/samples/shoe.jpg");
    	userRepository.save(u5);
    	User u6 = new User();
    	u6.setUsername("Charlie");
    	u6.setPassword(PasswordEncoder.hashPassword("encodedPassword"));;
    	u6.setFavoriteLanguage(new FavoriteLanguage(null,"Java", "Medio"));
    	u6.setProfileImage("https://res.cloudinary.com/djnkw1sa9/image/upload/v1691188155/samples/shoe.jpg");
    	...
    	u7.setProfileImage("https://res.cloudinary.com/djnkw1sa9/image/upload/v1691188155/samples/shoe.jpg");
    	...
    	u8.setProfileImage("https://res.cloudinary.com/djnkw1sa9/image/upload/v1691188155/samples/shoe.jpg");
    	...
    	u9.setProfileImage("https://res.cloudinary.com/djnkw1sa9/image/upload/v1691188155/samples/shoe.jpg");
